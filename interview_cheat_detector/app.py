...
def quiz_submit():
    ...
    sess.update({"answers":answers,"submitted":True,"score":correct,"percentage":pct,"grade":grade,
        ...
        "no_face_count":stats["no_face_count"],"face_mismatch_count":stats["face_mismatch_count"],
        "screen_record_count":stats["screen_record_count"],"identity_score":stats["identity_score"]})
